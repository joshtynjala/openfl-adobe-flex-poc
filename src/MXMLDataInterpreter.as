...
public class MXMLDataInterpreter
{
     ...
     *  @productversion Royale 0.0
     */
    public static function generateMXMLArray(document:Object, parent:DisplayObjectContainer, data:Array):Array
    {
        var comps:Array = [];
     ...
     */
    private static function initializeStrandBasedObject(document:Object, parent:DisplayObjectContainer, comp:Object, data:Array, i:int):int
    {
        var m:int;
        var j:int;
        var name:String;
     ...
     */
    public static function generateMXMLInstances(document:Object, parent:DisplayObjectContainer, data:Array):void
    {
		if (data != null) {
