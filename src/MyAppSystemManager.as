package
{
    ...
    public class MyAppSystemManager extends SystemManager
    {
        public function MyAppSystemManager()
        {
            ...
            org.apache.royale.reflection.getQualifiedSuperclassName;
        ...
        override mx_internal function initialize():void
        {
            ...
            var inheritingStyles:Array = ["fontGridFitType","kerning","errorColor","color","leading","fontAntiAliasType","backgroundDisabledColor","textIndent","barColor","fontThickness","fontFamily","textSelectedColor","dropShadowColor","fontWeight","textAlign","fontSharpness","letterSpacing","textDecoration","fontStyle","disabledColor","modalTransparencyColor","modalTransparencyBlur","themeColor","modalTransparencyDuration","modalTransparency","fontSize","textRollOverColor","rollOverColor","selectionColor","selectionDisabledColor"];
            var i:int = 0;
            while (i < inheritingStyles.length)
            {
                StyleManager.registerInheritingStyle(inheritingStyles[i]);
                i++;
            }
        }
